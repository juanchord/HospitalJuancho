...
namespace HospitalJuancho.Controllers
{
    public class PacientesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID_Paciente,Cedula,Nombre,Asegurado")] Pacientes pacientes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID_Paciente,Cedula,Nombre,Asegurado")] Pacientes pacientes)
        {
            if (ModelState.IsValid)
            {
