...
namespace HospitalJuancho.Controllers
{
    public class MedicosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID_Medico,Nombre,Exequatur,Especialidad")] Medicos medicos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID_Medico,Nombre,Exequatur,Especialidad")] Medicos medicos)
        {
            if (ModelState.IsValid)
            {
