...
namespace HospitalJuancho.Controllers
{
    public class HabitacionesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID_Habitacion,Numero,Tipo,Precio")] Habitaciones habitaciones)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID_Habitacion,Numero,Tipo,Precio")] Habitaciones habitaciones)
        {
            if (ModelState.IsValid)
            {
